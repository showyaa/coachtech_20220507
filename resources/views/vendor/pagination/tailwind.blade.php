...
@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="nav">
        ...
        <div class="count_data">
            <div>
                <p class="">
                    <span class="count_text">全</span><span class="count_text">{{ $paginator->total() }}</span><span class="count_text">件中</span>
                    <span class="count_text">{{ $paginator->firstItem() }}</span><span class="count_range"> ~</span>
                    <span class="count_text">{{ $paginator->lastItem() }}</span><span class="count_text">件</span>
                </p>
            </div>
